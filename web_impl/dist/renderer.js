...
function editRegister(regValueSpan, regName) {
    const currentValue = lynxMachine[regName];
...
function highlightCurrentInstruction() {
    ...
    const currentCell = instructionsGrid.querySelector(`[data-index="${lynxMachine.pc}"]`);
    if (currentCell) {
        currentCell.classList.add("current-instruction");
    }
}
// NOTE: This is very much hacked together!!
function renderByteArray(array, containerId) {
...
function editCell(cell, index, array) {
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Add event listeners
    (_a = document
        .getElementById("display-toggle")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", toggleNumberSystem);
    (_b = document.getElementById("assembly-submit")) === null || _b === void 0 ? void 0 : _b.addEventListener("click", () => {
        const assemblyInputDoc = document.getElementById("assembly-input");
        if (assemblyInputDoc) {
    ...
    function updateSpeedDisplay() {
        if (speedInput)
            speedInput.value = vmSpeed.toString();
    }
    if (speedDecrease) {
    ...
    (_c = document.getElementById("step-btn")) === null || _c === void 0 ? void 0 : _c.addEventListener("click", () => {
        if (!vmRunning) {
